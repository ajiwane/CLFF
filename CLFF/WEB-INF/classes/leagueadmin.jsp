	    ...
	    <div id="container-eyecatcher">
		  ...
		  <div class="style2">
		    <div align="center"></div>
                	...
                	<div>
                	  <div> 
       	                <h1>Help - League administration</h1>
       	                <div> How can I invite other people to join my league? </div>
       	                <div>
                          <p>If you are the league administrator then you can invite people from  your league administration page. If not, then you will need to send  them the league code that you used when entering the league. The league  founder can get the code from the 'Administer League' page, which is  available from  Leagues . </p>
   	                    </div>
       	                <div> How do I ban a team from a league? </div>
       	                <div>
                          <p>This feature is only available to the creator of the league. On the  Leagues  page the league creator will find a link to 'Administer League'. From  here teams can be banned, new players invited and the league forum  cleared. These teams will be permanently banned. If you would like to  let them back in the league you will need to unbar them. They will have  to enter the code again to join the league. </p>
   	                    </div>
       	                <div> After a change of heart I want to let someone back in my league. How can I do this? </div>
       	                <div>
                          <p>You need to remove their ban by unchecking the  box next to their name on the 'Administer League' page. They will then  need to rejoin the league by entering the league code. </p>
   	                    </div>
       	                <p>&nbsp;</p>
   	        </div>
       	    </div>
